window.onload = function() {
    ...
    function triangle(a, b, c) {
        ...
        normalsArray.push(a.slice(0, 3));
        normalsArray.push(b.slice(0, 3));
        normalsArray.push(c.slice(0, 3));
    }
    ...
    document.getElementById("kdSlider").oninput = function(event) {
        var kdValue = parseFloat(event.target.value);
        kd = vec4(kdValue, 0.5, 0.5, 1.0);
        gl.uniform4fv(kdLoc, flatten(kd));
    };
